  ...
  return (
    <div className="grid gap-4 md:grid-cols-10">
      ...
      <div className="p-6 bg-secondary rounded-lg md:col-span-3">
        ...
        <div className="flex items-baseline text-4xl font-bold animate-number-scroll whitespace-nowrap text-success">
          {roi}
          <span className="text-4xl font-bold ml-1 text-success">
